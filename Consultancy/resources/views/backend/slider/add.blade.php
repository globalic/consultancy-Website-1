                                             ...
                                             <form action="{{route('slider.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                           @csrf
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="title" placeholder="Slider Title" class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
                                                            @if ($errors->has('title'))
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><textarea name="description" id="short_description" rows="9" placeholder="Description about Slider" class="form-control"></textarea></div>
                                                           </div>
