...
<meta charset="utf-8">
    ...
    <meta property="og:url" content= "{{url('/home/abroadstudy/'.$key->id)}}">
    <meta property="og:image" content="{{url('/images/AbroadStudy/'.$key->image)}}">
        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <div class="about-inner-img">
                    <img src="{{url('/images/AbroadStudy'.'/'.$key->image) }}" alt="{{$key->title}}">
                </div>
                <br>
                <div class="col-lg-12">
